...
namespace CSparse.Complex
{
    ...
    public static class CreateSparse
    {
        ...
        public static SparseMatrix Zeros(int rows, int columns, int valueCount = 0)
        {
            ...
            A.Values = new Complex[valueCount];
        ...
        public static SparseMatrix Laplacian(int nx, Complex[] eigenvalues = null)
        {
            if (nx == 1)
            {
            ...
            var C = new CoordinateStorage<Complex>(nx, nx, nx);
        ...
        /// <param name="eigenvalues">Vector to store eigenvalues (optional).</param>
        /// <returns>Laplacian sparse matrix.</returns>
        public static SparseMatrix Laplacian(int nx, int ny, Complex[] eigenvalues = null)
        {
            var Ix = Eye(nx);
            var Iy = Eye(ny);
        ...
        public static SparseMatrix Wathen(int nx, int ny, int seed = 834651)
        {
            ...
            var C = new CoordinateStorage<Complex>(order, order, nx * ny * 64);
